...
public class MusicMenuGUI extends JPanel {
	...
	public void addActionListeners() {
		...
		playButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				setVisible(false);
				SinglePlayerGUI spgui = new SinglePlayerGUI(user, selectedSong);
				DDR.cardPanel.add(spgui);
				spgui.setVisible(true);	
				spgui.requestFocusInWindow();
				//spgui.playSong(selectedSong);
			}
